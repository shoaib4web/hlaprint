    ...
    <section class="table-components">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4">
                     <div class="card-style mb-30">
                         <h6 class="mb-10">Total Sales :</h6><h4>{{$data['totalSales']}} SAR</h4>
                     </div>
                </div>
                <div class="col-lg-4">
                     <div class="card-style mb-30">
                         <h6 class="mb-10">Total Online :</h6><h4>{{$data['totalSalesOnline']}} SAR</h4>
                     </div>
                </div>
                <div class="col-lg-4">
                     <div class="card-style mb-30">
                         <h6 class="mb-10">Total Cash :</h6><h4>{{$data['totalSalesCash']}} SAR</h4>
                     </div>
                </div>
            </div>
