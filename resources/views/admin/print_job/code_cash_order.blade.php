                                                        ...
                                                        @foreach($fetchJobs as $item)
                                                            ...
                                                            <td>
                                                                ...
                                                                <!-- <a href="{{ url('generate-new-invoice/' . $item->code) }}"
                                                                    ...
                                                                    Invoice</a> -->
                                                                @if($item['status'] != 'Sent to Print' )
                                                                
                                                                <a href="{{ url('approve-cash-order/' . $item->code) }}"
                                                                class="main-btn active-btn square-btn btn-hover btn-sm">Approve</a>
                                                                
                                                                @else
                                                                
                                                                <a href="{{ url('approve-cash-order/' . $item->code) }}"
                                                                class="main-btn square-btn btn-hover btn-sm">Reprint</a>
