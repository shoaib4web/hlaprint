            ...
            <div class="Option Option0 active">
                    ...
                    <div class="box color">
                        ...
                        <div class="top">
                            ...
                            <div class="input mInput  blackwhite active" onclick=" totalPriceCalculation('color', 'blackwhite');ActiveOption(this, 'Option0', 'mInput')">
                            ...
                            <div class="input mInput"  onclick=" totalPriceCalculation('color', 'color');ActiveOption(this,'Option0', 'mInput')"> 
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="inputs" >
                    ...
                    <div class="input modalinput  active" onclick="totalPriceCalculation('sides', 'oneside'); ActiveOption(this,'Option0', 'modalinput')">
                ...
                <div class="input modalinput " onclick="totalPriceCalculation('sides', 'twoside'); ActiveOption(this,'Option0', 'modalinput')">
            ...
            <p hidden  id="endRangePrice">{{$end}} </p>
                ...
                <div class="input rangeinput  active" onclick="ActiveOption(this,'Option0', 'rangeinput')">
                ...
                <div class="input  input2" >
                    ...
                    <div class="custom rangeinput " onclick="ActiveOption(this,'Option0', 'rangeinput')">
                        ...
                        <input  @if($printJob->total_pages <= '1') disabled @endif type="checkbox" value="custom" class="checkbox">
                    ...
                    <div class="from">
                            ...
                            @endif
                                ...
                                <select @if($printJob->total_pages <= '1') disabled @endif name="to[]" class="topage" id="endRange" onchange="PageRange(event, 'to','option0')">
            ...
            @php $data = unserialize($pricing->size_amount); @endphp
                ...
                <select name= "page_size[]" class="page_size" id="pageSize" onchange="Page(event, 'page','option0')">
            ...
            <!--        </div>-->
                ...
                <div class="box payment">
                    ...
                    <div class="top">
                        ...
                        <img src="{{ asset('public/assets/img/Applepay.png') }}" alt="">
                        ...
                        <img src="{{ asset('public/assets/img/mada.jpg') }}" alt="">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path style="fill : #8A8A8A" d="M96 96V320c0 35.3 28.7 64 64 64H576c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H160c-35.3 0-64 28.7-64 64zm64 160c35.3 0 64 28.7 64 64H160V256zM224 96c0 35.3-28.7 64-64 64V96h64zM576 256v64H512c0-35.3 28.7-64 64-64zM512 96h64v64c-35.3 0-64-28.7-64-64zM288 208a80 80 0 1 1 160 0 80 80 0 1 1 -160 0zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V360c0 66.3 53.7 120 120 120H520c13.3 0 24-10.7 24-24s-10.7-24-24-24H120c-39.8 0-72-32.2-72-72V120z"/></svg>
