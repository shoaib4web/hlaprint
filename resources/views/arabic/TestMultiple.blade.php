...
$uniquePageSizes = $collection->pluck('page_size')->unique();@endphp
                    ...
                    <div class="box greyed payment disabled">
                        <div class="top">
                         ...
                         <apple-pay-button id="apple-pay-button" buttonstyle="black" type="pay" locale="en-US"></apple-pay-button>
    ...
    <script>
        // Check if the user can use Apple Pay
        ...
        document.getElementById('apple-pay-button').addEventListener('click', async () => {
            const paymentRequest = {
                ...
                currencyCode: 'SAR',
                total: {
                    label: 'Hlaprint Services',
                    amount: '10.00' // Amount to charge
                },
                supportedNetworks: ['visa', 'masterCard', 'amex'], // Add supported networks
                merchantCapabilities: ['capability3DS', 'capabilityDebit'],
            };
            ...
            session.onvalidatemerchant = async (event) => {
                ...
                const response = await fetch('/apple-pay/create', {
                    method: 'POST',
                    headers: {
            ...
            session.onpaymentauthorized = (event) => {
                ...
                // Handle the payment with ClickPay
                // ...
