...
<body>
    ...
    <section class="document">
        ...
        <div class="right">
            <div class="container">
                ...
                <form method="post" action="{{ route('eSubmitDocument') }}" id="form1">
                    ...
                    <!-- <div class="box color" style="height: 18.4rem;!important">
                        <div class="top">
                            <h3>
                               Upload Document
                            </h3>
                    ...
                    <div class="box color">
                        ...
                        <div class="input mInput  blackwhite active" onclick="totalPriceCalculation('color', 'blackwhite'); ActiveOption(this, 'mInput', 'blackwhite')">
                            <div class="price">

                                <p class="title" style="margin-bottom:0;">Black/White</p>
                                <p  style="margin-bottom:0;">

                                    <span id="bwPrice">{{isset($pricing)?$pricing->black_and_white_amount:"0.333"}} </span>.00 SAR
                                </p>
                            </div>
                            <input type="checkbox" name="color" value="false"
                        ...
                        <div class="input mInput" onclick="totalPriceCalculation('color', 'color'); ActiveOption(this, 'mInput', 'color') ">
                            <div class="price">
                                ...
                                <p style="margin-bottom:0;">
                                    <span id ="colorPrice">{{isset($pricing)?$pricing->color_page_amount:"2"}} </span>.00 SAR
                                </p>
                            </div>
                        ...
                        <div class="options" onclick="Modal(event, true)">
                    ...
                    <div class="box copies">
                        ...
                        <div class="input">
                        <button type="button" onclick="Copies('noofcopies', 'subt')">-</button>
                            
                            <p class="noofcopies" style="margin-bottom:0">1</p>
                            <input type="hidden" class="noofcopies" value="1" name="copies" id="copies">
                            <button type="button" onclick="Copies('noofcopies', 'add')" style="border-left : 1px solid rgba(0, 68, 142, 0.25)">+</button>
                    ...
                    <div class="box payment">
                        ...
                        <div class="input payInput active" onclick="ActiveOption(this, 'payInput')">
                            ...
                            <input type="checkbox" checked name="type" class="checkbox">
                        </div>
        ...
        <div class="modal" id="advance_modal">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="inputs" style="justify-content: space-between; padding-left : 0;">
                         ...
                         <!-- <p hidden id="totalpage">{{isset($printJob)?$printJob->total_pages:"1"}} </p> -->
                        ...
                        <div class="input modalinput active" onclick="totalPriceCalculation('sides', 'oneside'); ActiveOption(this, 'modalinput', 'onesided')" >
                            <p class="title" style="margin-bottom:0">One Sided </p><span class="design">(+ {{isset($pricing)?$pricing->one_side:"0.333"}}.00 SAR)</span>
                            <input type="checkbox" name="sides" value="one"
                                @if (isset($print_job)) checked="{{ !$print_job->double_sided }}" @else checked="true" @endif
                                class="checkbox">
                        </div>
                        <div class="input modalinput" onclick="totalPriceCalculation('sides', 'twoside'); ActiveOption(this, 'modalinput', 'twosided')">
                            <p class="title" style="margin-bottom:0">Two Sided </p><span class="design">(+ {{isset($pricing)?$pricing->double_side:"0.333"}}.00 SAR)</span>
                            <input type="checkbox" name="sides" value="two"
                ...
                <div class="row range">
                    ...
                    <div class="input rangeinput active" onclick="ActiveOption(this, 'rangeinput', 'all')">
                        <p class="title" style="margin-bottom:0">All</p>
                        <input type="checkbox" name="range" value="all" checked="true" class="checkbox">
                    </div>
                    <div class="input  input2">
                        <div class="custom rangeinput" onclick="ActiveOption(this, 'rangeinput', 'custom')">
                        ...
                        <div class="pages">
                            <div class="from">
                                ...
                                <select @if($printJob->total_pages <= '1') disabled @endif class="frompage" name="pages_start" id="startRange" onchange="PageRange(event, 'from')" >
                            ...
                            <div class="to">
                                ...
                                <select @if($printJob->total_pages <= '1') disabled @endif name="page_end" class="topage" id="endRange" onchange="PageRange(event, 'to')">
                                @if($printJob->total_pages > '1') 
                                    @for($i=1; $i<=$printJob->total_pages ; $i++)
                                      <option value="{{$i}}">{{$i}}</option>
                                    @endfor
                ...
                <div class="row size"  style="display : flex; justify-content:space-between;">
                    ...
                    $displayAmount = ($amount == 0) ? '1' : $amount;
                    @foreach ($data as $size => $amount)
                    @php
                       
                    @endphp
                    <option  @if($size == 'A4') selected @endif value="{{ $amount }}">{{ $size }} @if($size != 'A4') <span style= " font-weight: 600;!important">( + {{ $amount }}.00 SAR)</span> @endif</option>
          
                    @endforeach
                        
                    </select>
                </div>
                <button type="button" onclick="HideModal();">DONE</button>
            </div>
        </div>
        ...
        <div class="modal confirmModal" id="" >
            ...
            <div class="close" onclick="Modal(event, false)">
                ...
                <img src="./img/lineIcon.png" alt="" style="width: 9.2rem; height: 9.2rem;">
...
updatePrice()
        ...
        const ActiveOption = (e, input, value) => {
...
const Page = (e, value)=>{
    ...
    updatePrice()
        ...
        const Copies = (e, value) => {
            const p = document.querySelector(`.${e}`)
            const copy = document.getElementById("copies");
            if (value == "add") {
