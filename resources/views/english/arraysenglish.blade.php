    ...
    <section class="document">
        <div class="left">
            ...
            <div class="header">
                ...
                @if($shop)
                <a href="{{route('arabicView',[$code,$shop])}}" class="btn">العربية</a>
                @else
                <a href="{{route('arabicView',[$code])}}" class="btn">العربية</a>
                @endif
            </div>
            ...
            <div class="uploadFilesModal">
                ...
                <div class="container screen2 Op0 UploadModal0">
                    <div class="box color">
                        ...
                        <div id="bw" class="input mInput   bwcolor blackwhite active"
                            ...
                            <div class="price">
                                ...
                                <p id="bwPrice" style="display:flex"><span
                                        style="margin-right : .4rem;font-size: 1.3rem;font-weight: 600;color: #007FFF40;">{{$bwPageAmount}}
                                    pages for
                                        {{$bwPrice}} SAR</span>
                            </div>
                        ...
                        <div id="color" class="input mInput  colored"
                            ...
                            <div class="price">
                                ...
                                <p id="colorPrice" style="display:flex">{{$colorPageAmount}} pages for {{$colorPrice}} SAR
                                </p>
                            </div>
                    ...
                    <div class="box copies total">
                        <div class="top">
                            <h3>
                             Total<span style="font-size:1rem">(Current Selection)</span>
                            </h3>
                        </div>
                        <div class="input">
                            <p class="totalPriceValue">1</p> <span style="margin-right : .4rem">SAR</span>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="inputs">
                                    <div class="input modalinput   oneSide active "
                                        ...
                                        <p class="title">من Single Sided {{isset($pricing)?$pricing->one_side:"0.333"}} .00
                                            ريال </p>
                                    ...
                                    <div class="input modalinput   twoSide"
                                        ...
                                        <p class="title">Double Sided {{isset($pricing)?$pricing->double_side:"0.333"}} ريال
                                        </p>
                            ...
                            <div class="row range">
                                ...
                                <div class="input rangeinput  active"
                                    ...
                                    <p class="title">All Pages</p>
                                    <input type="checkbox" class="checkbox" checked>
                                </div>
                                <div class="input  input2">
                                    <div class="custom rangeinput "
                                        onclick="ActiveOption(this,'UploadModal0', 'rangeinput')">
                                        <p class="title">Specific</p>
...
$uniquePageSizes = $collection->pluck('page_size')->unique();@endphp
                            ...
                            <button class="classbtn" type="button"
                                onclick="Modal(this,'UploadModal0', false)">Save</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="Option Option{{$count}} @if(!$count) {{ 'active' }} @endif">
                            <div class="box color">
                                ...
                                <div class="input mInput  blackwhite active"
                                    ...
                                    <div class="price">
                                        ...
                                        <p style="display : flex"><span style="margin-right : .4rem">{{$bwPageAmount}} pages for {{$bwPrice}} SAR</span> </p>
                                    </div>
                                    <input type="checkbox" name="color[]" value="false" class="checkbox" checked>
                                </div>
                                <div class="input mInput"
                                    ...
                                    <img src="{{ asset('public/assets/img/color.png')}}" class="icon" alt="">
                                        ...
                                        <p style="display : flex"><span style="margin-right : .4rem">{{$colorPageAmount}} pages for {{$colorPrice}} SAR</span></p>
                                    </div>
                                    <input type="checkbox" name="color[]" value="true" class="checkbox">
                                </div>
                            ...
                            <div class="box copies total" style="display:">
                                ...
                                <div class="input">
                                    ...
                                    <span style="margin-right : .4rem">SAR</span>
                                </div>
                            </div>
...
$uniquePageSizes = $collection->pluck('page_size')->unique();@endphp
                                    ...
                                    <button type="button" onclick="Modal(this,'Option{{$count}}', false)">Save</button>
                                </div>
                            </div>
                            ...
                            <div class="modal saveModal" style="    position: fixed;
                                ...
                                text-align: center;">
                                    ...
                                    Save Selection
                                    <button type="button" onclick="SaveModal(this,'Option{{$count}}', false)">Save</button>
                                </div>
                            </div>
                        </div>
                        @php
                            ...
                            <div class="box color">
                                ...
                                <div class="input mInput"
                                    ...
                                    <div class="price">
                                        ...
                                        <p style="display : flex"><span style="margin-right : .4rem">{{$colorPageAmount}} pages for {{$colorPrice}}</span></p>
                                    </div>
                                    <input type="checkbox" name="color[]" value="true" class="checkbox">
                                </div>
                                <input type="hidden" name="colorType" id="colorType" value="blackwhite">
                            ...
                            <div class="modal" style="    position: fixed;
                                ...
                                <div class="container">
                                    ...
                                    <div class="row range greyed">
                                        ...
                                        <h3> (Please Select a Single file)   Select Pages</h3>
                                        <div class="input rangeinput  active "
...
$uniquePageSizes = $collection->pluck('page_size')->unique();@endphp
                                    ...
                                    <button type="button"
                                        onclick="Modal(this,'AllSelectedOptions', false)">Save</button>
                                </div>
                            </div>
                            ...
                            <div class="modal saveModal" style="    position: fixed;
                                ...
                                text-align: center;">
                                    ...
                                    Save Selection
                                    <button type="button" onclick="SaveModal(this,'AllSelectedOptions', false)">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box greyed payment totaldocprice">
                        <div class="top">
                            <h3>
                                 Total<span style="font-size:1rem">(All Documents)</span>
                            </h3>
                        </div>
                        <div class="input ">
                    ...
                    <div class="box greyed payment disabled">
                        ...
                        <div class="input payInput" onclick="ActiveOption(this,'Option0', 'payInput')">
                            ...
                            <p><span>                           </span>Apple Pay (Only MADA) </p>
                        ...
                        <div class="input payInput" onclick="ActiveOption(this,'Option0','payInput')">
                            ...
                            <p>Cash or Other Cards at Cashier</p>
